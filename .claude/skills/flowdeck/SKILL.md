...
| Record simulator video | `flowdeck ui simulator record -S "iPhone 16" --output <path>` | same |
...
- If you see `xcrun simctl io recordVideo`, use `flowdeck ui simulator record -S "iPhone 16" --output <path>` instead.
