...
// MARK: - Sample Entry Helper

/// Returns sample entry content that varies based on the date
/// This allows different entry titles to be displayed as you navigate through dates
private func getSampleEntryContent(for date: Date) -> String {
    let calendar = Calendar.current
    let day = calendar.component(.day, from: date)

    // Rotate through 5 different sample entries based on day of month
    switch day % 5 {
    case 0:
        return """
# Coffee Thoughts
